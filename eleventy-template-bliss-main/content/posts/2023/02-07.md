...
Outre une introduction sur la structure et l'histoire du Web, cette première séance a traité de la sémantique et de la syntaxe du HTML, le langage de balisage qui structure les contenus du Web.

 <iframe
      src="/images/slides-export.pdf"
      width="100%"
      height="450px"
      loading="lazy"
      title="diapositives"
...
Après un aperçu rapide des principales [balises offertes par HTML](https://web.stanford.edu/group/csp/cs21/htmlcheatsheet.pdf), nous avons examiné de plus près l'insertion de certains éléments dans une page web. En particulier, nous avons observé :
